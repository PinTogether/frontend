  ...
  function markerIconRenderer(markerdata: MarkerData) {
    if (markerdata.pinCount <= 1) {
      return [
        ...
        '<b style="justify-content: center; text-wrap: balance; text-align: center; font-size: 14px; font-weight: 600; text-shadow: -2px 0 #fdfdfd, 0 2px #fdfdfd, 2px 0 #fdfdfd, 0 -2px #fdfdfd; margin-top: 5px;">',
