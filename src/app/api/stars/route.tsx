...
const results: PlaceStarred[] = [
  ...
  },
  {
    id: 580229,
    name: "홍대구슬아이스크림",
    roadNameAddress: "서울특별시 마포구 와우산로27길 26, 지1층 일부호 (서교동)",
    placePinCnt: 1,
  ...
  },
  {
    id: 538102,
    name: "아이스크림 소사이어티",
    roadNameAddress: "서울특별시 용산구 한남대로20길 47, 1층 101호 (한남동)",
    placePinCnt: 1,
  ...
  },
  {
    ...
    roadNameAddress: "서울특별시 마포구 와우산로21길 21-14 (서교동, 지하1층)",
    placePinCnt: 1,
  ...
  },
  {
    ...
    roadNameAddress: "서울특별시 성북구 보문로31길 36, 1층(우측) (삼선동5가)",
    placePinCnt: 1,
